...
integer :: npos,ntps, n,v,i,j,l,ph,m, maxpot1,minpot2,ideb
...
double precision :: xmin, xmax, requ, diss,massreduite, morse,lieprobv
...
!!!!!!!!!!!!!!
       if(i.le.1024) then
           ...
           enddo
               call simpson(npos,delr,proj,proj_xmu_chi(i))
